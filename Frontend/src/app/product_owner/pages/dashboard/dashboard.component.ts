...
export class AppOwnerDashboardComponent {
  ...
  fileSelected = false; // Variable to track if a file is selected
  ...
  onFileSelected(event: any): void {
    ...
    if (selectedFile) {
      ...
      // For example, you can upload it to a server using HTTP requests.
      console.log('Selected file:', selectedFile);

      // Update the variable to show the file information and hide the file input
      this.fileSelected = true;
      this.fileInputRef.nativeElement.value = 0;
    }
